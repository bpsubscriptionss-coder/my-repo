      ...
      <div className="pt-32 pb-24 min-h-screen">
        <div className="max-w-[100rem] mx-auto px-8">
          ...
          >
            ...
            <div className="w-32 h-1 bg-gradient-to-r from-electric-teal to-neon-magenta"></div>
          </motion.div>
            ...
            <div className="space-y-12">
              {cases.map((caseItem, caseIndex) => (
                <motion.div
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ duration: 0.6, delay: 0.2 + caseIndex * 0.05 }}
                  className="bg-gradient-to-br from-electric-teal/5 to-neon-magenta/5 border border-electric-teal/20 rounded-2xl p-8"
                >
                    ...
                    {caseItem.questions.map((question, questionIndex) => (
                      <div key={questionIndex} className="space-y-4">
                        ...
                        <Textarea
                          ...
                          className="min-h-[200px] bg-background border-electric-teal/30 text-foreground font-paragraph resize-none"
                        />
                      </div>
                    ))}
                  </div>
              ...
              >
                <Button
                  ...
                  className="bg-electric-teal hover:bg-electric-teal/90 text-electric-teal-foreground font-heading text-lg px-12 py-6 rounded-lg transition-all duration-300 hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {isSubmitting ? (
                    <>
